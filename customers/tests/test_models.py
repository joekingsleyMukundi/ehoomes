...
class TestModels(TestCase):
    ...
    def test_host_dashboard_model(self):
        ...
        self.assertEqual(self.host_dashboard.host.host_date, '20/12/2019')
    ...
    def test_host_tenant_flow_model(self):
        self.host_tenant_flow = tenant_flow.objects.create(host=self.host, tenant=self.user, room=self.rooms, status='test', date='test',)
        ...
        self.assertEqual(self.host_tenant_flow.host.host_date, '20/12/2019')
    ...
    def test_host_recent_transactions_model(self):
        self.host_recent_transactions = recent_transactions.objects.create(host=self.host, tenant=self.user, room=self.rooms, status='test', date='test', amount=10000, transaction_type='test', transaction_to='test',  transaction_from='test', transaction_id='1')
        ...
        self.assertEqual(self.host_recent_transactions.host.host_date, '20/12/2019')
        ...
        self.assertEqual(self.host_recent_transactions.date, 'test')
    ...
    def test_billing_activities_model(self):
        self.billing_activities = billing_activities.objects.create(host=self.host, tenant=self.user, message='test', date='test',)
        ...
        self.assertEqual(self.billing_activities.date, 'test')
