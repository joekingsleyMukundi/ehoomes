...
class TestModels(TestCase):
  def setUp(self):
    self.user = users.objects.create(username='test', phone='123456789', email='test@gmail.com')
  ...
  def test_tenant_dashboard_model(self):
    ...
    self.assertEqual(self.tenant_dashboard.user.phone, '123456789')
  ...
  def test_keja_invoices(self):
    ...
    self.assertEqual(self.keja_invoices.user.phone, '123456789')
