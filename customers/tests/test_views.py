...
class TestViews(TestCase):
    def setUp(self):
        ...
        self.user = users_model.objects.create(username='test', phone='123456789', email='joekingsleymukundi@gmail.com',
                                               password='test')
    ...
    def test_user_profile_view_POST(self):
        response = self.client.post(reverse('user_profile'), self.auth_headers,
                                    {'username': 'test', 'phone': '123456789', 'email': 'test@gmail.com'})
